function Header() {
    return (
        <div className="homePage">
            ...
            <p className="homeText">Should our adventurers decide to explore, the house will have an upstairs where the auction is not being held, but where the blood trail would lead to. If successfully followed, not without darkening skies, and perhaps lightning. Other frightening events will occur. 
